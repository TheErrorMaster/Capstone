...
def select():
    win5 = Toplevel(root)
    win5.title("Players")
    win5.geometry("400x400")
    win5.config(bg="green")
    title = Label(win5, text="Select the number of playes", bg="green", fg="white", font=("Helvetica", 20)).pack()
    user1_btn = Button(win5, text="one", height=3, width=20, bg="blue", fg="white", command=newWin1).pack(pady=10)
    user2_btn = Button(win5, text="two", height=3, width=20, bg="blue", fg="white", command=newWin2).pack(pady=10)
    user3_btn = Button(win5, text="three", height=3, width=20, bg="blue", fg="white", command=newWin3).pack(pady=10)

# Varaiables with location
title_lbl = Label(root, text="10,000 Dice", fg="white", bg="green", font=("Helvetica", 16)).pack()
play_btn = Button(root, text="play", height=3, width=20, bg="blue", fg="white", command=select).pack(pady=10)
